  ...
  const appsData = [
    {
      ...
      connectionCount: 1,
      flowCount: 1,
      iconUrl: 'http://localhost:3002/apps/deepl/assets/favicon.svg',
      key: 'deepl',
      name: 'DeepL',
      primaryColor: '0d2d45',
    ...
    },
    {
      ...
      connectionCount: 1,
      flowCount: 1,
      iconUrl: 'http://localhost:3002/apps/github/assets/favicon.svg',
      key: 'github',
      name: 'GitHub',
      primaryColor: '000000',
      supportsConnections: true,
    },
    {
      ...
      flowCount: 1,
      iconUrl: 'http://localhost:3002/apps/slack/assets/favicon.svg',
      key: 'slack',
      name: 'Slack',
      primaryColor: '4a154b',
      supportsConnections: true,
    },
    {
      ...
      flowCount: 1,
      iconUrl: 'http://localhost:3002/apps/webhook/assets/favicon.svg',
      key: 'webhook',
      name: 'Webhook',
      primaryColor: '0059F7',
