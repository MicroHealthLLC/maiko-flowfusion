...
function LoginForm() {
  ...
  React.useEffect(() => {
    ...
    if (!authentication.isAuthenticated) {
      // Define a dummy values object or fetch it from somewhere if needed
      const initialValues = {
        email: 'user@automatisch.io', // Replace with actual initial value
        password: 'sample', // Replace with actual initial password
      };
      handleSubmit(initialValues).catch(console.error);
    }
